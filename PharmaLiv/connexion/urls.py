...
urlpatterns = [
    ...
    path('patient/', include([
        ...
        path('login/', auth_views.login,{'template_name':'patient/login.html'}), #meme chose pour .login ,patient/login.html est la page pour se connecter , lorsqu'on django nous gere la verification et nous redirige vers l'url indiqué dans input type hidden de la page html
    ])),
]